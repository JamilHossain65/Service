...
class PrimaryTextField: UITextField {
    ...
    private func initializeSetup() {
        ...
        self.font                       = AppFonts.HiraginoSansW6(ofSize: 21.sp)
        self.textColor                  = AppColors.grayText33
        self.tintColor                  = AppColors.grayText33
...
//        addBorderProperties(borderWidth: 2.0, borderColor: NHTheme.shared.THEME_DEEP_GREEN, shadowColor: NHTheme.shared.THEME_PURE_WHITE)
        self.setUnderLine(height: 1.5.s, color: UIColor.primaryColor)
    }
