...
extension CellView: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
...
//        return subCatList?.count ?? 0
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        return CGSize(width:collectionView.frame.width , height: 93 * appConstant.heightRatio )
